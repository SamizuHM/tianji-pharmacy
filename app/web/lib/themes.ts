...
export const sidebarThemes: Record<SidebarThemeName, SidebarThemeConfig> = {
  ...
  light: {
    ...
    brand: {
      ...
      title:
        "whitespace-nowrap text-base font-semibold tracking-normal text-foreground",
      subtitle:
        "mt-1 flex items-center gap-1.5 text-[11px] font-medium text-muted",
    ...
    nav: {
      ...
      itemActive:
        "border-border bg-accent font-semibold text-primary shadow-sm",
      itemInactive:
      ...
      iconWrapperInactive:
        "bg-secondary text-muted group-hover:bg-accent group-hover:text-primary",
      iconSize: "size-4",
