...
export default async function LoginPage() {
  ...
  return (
    <main className="flex min-h-screen bg-[#f5f7fa] text-slate-900">
      <section className="hidden flex-1 flex-col justify-between overflow-hidden bg-[linear-gradient(135deg,#faf8ff_0%,#e8eeff_100%)] px-16 py-12 lg:flex">
      ...
      <section className="flex w-full shrink-0 items-center justify-center bg-[#f5f7fa] p-6 lg:w-[540px] xl:w-[600px]">
        <LoginForm />
      </section>
    </main>
  );
